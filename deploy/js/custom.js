...
var data = shuffle(carpet_data.data);
...
function portfolio_init(){
	if(data.length > 1){
		var work_arr ="";
		//$("#work-grid").empty();
		console.log($(".work-item").length);
		for (var i = 0; i < 12; i++) {
			var work = '<li class="work-item mix '+data[i].collection.toLowerCase()+'"><a href="rug-single.html#'+parseInt(data[i].id)+'" target="_blank" class="work-ext-link"><div class="work-img"><img class="work-img" src="'+data[i].thumb+'" alt="Work" /></div><div class="work-intro"><h3 class="work-title">'+data[i].name+'</h3><div class="work-descr">'+data[i].collection+'</div></div></a></li>';
			work_arr = work_arr + work;
		}
		$("#work-grid").append(work_arr);
		initWorkFilter();
	}
	else{
		portfolio_init();
...
function add_portfolio(){
	...
	var work_arr ="";
		//$("#work-grid").empty();
		var l = $(".work-item").length;
		for (var i = l; i < (l + 12); i++){
			if(typeof data[i] != "undefined"){
				var work = '<li class="work-item mix '+data[i].collection.toLowerCase()+'"><a href="rug-single.html#'+parseInt(data[i].id)+'" class="work-ext-link"><div class="work-img"><img class="work-img" src="'+data[i].thumb+'" alt="Work" /></div><div class="work-intro"><h3 class="work-title">'+data[i].name+'</h3><div class="work-descr">'+data[i].collection+'</div></div></a></li>';
				work_arr = work_arr + work;
			}
			else{
				$(".load-more-btn").fadeOut(300);
				break;
			}
		...
		$("#work-grid").imagesLoaded(function(){
		 /*var iso = new Isotope('#work-grid',{
	         ...
	         fselector = $(".filter.active").attr('data-filter');
			 work_isotope.appended(work_arr);
			 work_isotope.reloadItems();
